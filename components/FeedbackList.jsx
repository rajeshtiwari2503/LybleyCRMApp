...
const FeedbackPage = ({ data, RefreshData }) => {
  ...
  const renderFeedbackItem = ({ item }) => (
    <View style={styles.itemContainer}>
      ...
      <Text style={styles.itemText}>Customer: {item.customerName}</Text>
      <Text style={styles.itemText}>Created At: {new Date(item.createdAt).toLocaleString()}</Text>
      <Text style={styles.itemText}>Service Date:  {new Date(item.complaintCloseTime).toLocaleString()}</Text>
      <TouchableOpacity style={styles.viewButton} onPress={() => handleViewDetails(item)}>
        <Text style={styles.viewButtonText}>View</Text>
      </TouchableOpacity>
    </View>
          ...
          <View style={styles.modalContent}>
            {selectedFeedback && (
              <View>
                ...
                <View style={styles.row}>
                  <Text style={styles.modalText}>Overall Satisfaction:</Text>
                  <Rating imageSize={20} readonly startingValue={selectedFeedback.overallSatisfaction} style={styles.rating} />
                </View>
                <View style={styles.row}>
                  <Text style={styles.modalText}>Service Quality:</Text>
                  <Rating imageSize={20} readonly startingValue={selectedFeedback.serviceQuality} style={styles.rating} />
                </View>
                <View style={styles.row}>
                  <Text style={styles.modalText}>Timeliness:</Text>
                  <Rating imageSize={20} readonly startingValue={selectedFeedback.timeliness} style={styles.rating} />
                </View>
                <View style={styles.row}>
                  <Text style={styles.modalText}>Professionalism:</Text>
                  <Rating imageSize={20} readonly startingValue={selectedFeedback.professionalism} style={styles.rating} />
                </View>
                <View style={styles.row}>
                  <Text style={styles.modalText}>Recommendation Likelihood:</Text>
                  <Rating imageSize={20} readonly startingValue={selectedFeedback.recommendationLikelihood} style={styles.rating} />
                </View>
              </View>
            )}
            <TouchableOpacity style={styles.closeButton} onPress={() => setModalVisible(false)}>
