...
const EditServiceCenterProfile = ({ isVisible, RefreshData, onClose, user, onSave }) => {
    ...
    useEffect(() => {
        if (user) {
            setValue('serviceCenterName', user?.serviceCenterName || '');
    ...
    const onSubmit = async (data) => {
        try {
            setLoading(true);
            const endpoint = `/editService/${user._id}`;
        ...
        <Modal isVisible={isVisible} onBackdropPress={onClose}>
            <View style={styles.modalContent}>
                <ScrollView style={styles.scrollView}>
                    <Text style={styles.header}>Edit Center Profile</Text>
                    ...
                    <Controller
                        ...
                        rules={{
                            ...
                            pattern: { value: /^[0-9]{6}$/, message: 'Invalid postal code' },
                        }}
                        render={({ field: { onChange, value } }) => (
                            <TextInput
                                style={styles.input}
